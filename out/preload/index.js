...
const api = {
  // File dialogs
  openImages: () => electron.ipcRenderer.invoke("dialog:openImages"),
  openAudio: () => electron.ipcRenderer.invoke("dialog:openAudio"),
  saveExport: () => electron.ipcRenderer.invoke("dialog:saveExport"),
  // File operations
  ...
  exportProject: (options) => electron.ipcRenderer.invoke("project:export", options),
  // Settings
